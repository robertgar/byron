...
ON inmueble.est_fk = tipo_estado.id_esta WHERE `tip_in_fk`=4";
  ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="topnav" id="myTopnav">
  ...
  <a href="bodeg.php" class="active">Bodegas</a>
...
<div class="container">    
 ...
 if ($count == 0) {
echo "<div class='alert alert-danger'>En este momento no hay bodegas</div>";
