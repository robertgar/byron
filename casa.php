...
ON inmueble.est_fk = tipo_estado.id_esta WHERE `tip_in_fk`=2";
  ?>
<!DOCTYPE html>
<html>
<head>
...
<br><br>
    <button class="btn btn-success btn-lg btn-block redondeado" onClick="window.location.href='verca.php?cod=<?php echo $row["id_in"]; ?>'">Ver</button>
    <br>
