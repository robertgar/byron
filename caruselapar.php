...
$sql_query = "SELECT id_in, im1,tip_in_fk FROM inmueble WHERE tip_in_fk=1 ORDER BY id_in DESC limit 12";
...
$i++;
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      <button type="button" class="btn btn-primary" style="float:right" onClick="window.location.href='apart.php'">Ver Todos</button>
    </div>
  </div>
</div>
<div class="container">
